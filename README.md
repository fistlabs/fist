...
#TODO (0.0.1)
 ...
 3. Подумать о нескольких роутерах на одном сервере, если будет необходимо и ясно, то запланировать на 1.0.0
 4. Методы util/caller protected сделать членами Framework (будет неудобно тестировать)
