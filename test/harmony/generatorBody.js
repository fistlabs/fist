...
//var Track = require('../../connect/Runtime');
//var Vow = require('vow');
//var Fs = require('fs');
//
...
//        var fist = new Fist();
//
//        fist.decl('gen', function * (connect, errors, result, done) {
//
//            var res;
//
...
//            test.ok(connect instanceof Track);
//
//            res = yield 5;
//
...
//        var fist = new Fist();
//
//        fist.decl('gen', function * (connect) {
//            connect.send('!');
//
//            return yield 45;
//        });
